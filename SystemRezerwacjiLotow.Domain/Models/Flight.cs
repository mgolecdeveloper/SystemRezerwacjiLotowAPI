...
{
    /// <summary>
    /// Encja odpowiedzialna za przechowywanie danych związanych z lotem. Logika do tego modelu danych realizująca założenia z przydzielaniem
    /// zniżek jest zdefiniowana w repozytorium FlightsRepository
    /// </summary>
    public class Flight
    {
        [Key]
